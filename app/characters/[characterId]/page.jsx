  ...
  return (
    <article className="max-w-4xl mx-auto py-8">
      <div className="flex items-center mb-4">
        <h1 id={characterId} className="text-3xl font-serif mr-2">
          {character.name}
        </h1>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1">
          ...
          <div id="role-in-the-story" className="border-t border-gray-200 pt-4 mt-6">
            <h2 className="text-xl font-serif mb-2 flex items-center">
              Role in the Story
              <button className="ml-2 text-gray-400 hover:text-gray-600">
                <svg
          ...
          <div id="character-details" className="border-t border-gray-200 pt-4 mt-6">
            <h2 className="text-xl font-serif mb-2 flex items-center">
              Character Details
              <button className="ml-2 text-gray-400 hover:text-gray-600">
                <svg
            ...
            <div className="border border-gray-200 rounded-md overflow-hidden mb-6">
              <div className="bg-gray-100 p-2 font-medium text-center">{character.name}</div>
              <div className="p-4">
                <Image
                  src={character.image}
          ...
          <div id="key-missions" className="border-t border-gray-200 pt-4 mt-6">
            <h2 className="text-xl font-serif mb-2 flex items-center">
              Key Missions
              <button className="ml-2 text-gray-400 hover:text-gray-600">
                <svg
          ...
          <div id="notable-quotes" className="border-t border-gray-200 pt-4 mt-6">
            <h2 className="text-xl font-serif mb-2 flex items-center">
              Notable Quotes
              <button className="ml-2 text-gray-400 hover:text-gray-600">
                <svg
          ...
          <div id="biography" className="border-t border-gray-200 pt-4 mt-6">
            <h2 className="text-xl font-serif mb-2 flex items-center">
              Biography
              <button className="ml-2 text-gray-400 hover:text-gray-600">
                <svg
