      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="md:w-72">
          <div className="border border-gray-200 rounded-md overflow-hidden mb-6">
            ...
            <div className="p-4">
              <Image
                src="/images/cod4-screenshot.jpg"
                alt="Call of Duty 4: Modern Warfare Screenshot"
                width={240}
                height={200}
                className="mx-auto mb-4"
              />
              <div className="text-center text-sm text-gray-600 mb-4">Screenshot from Call of Duty 4: Modern Warfare</div>
          ...
          <div className="border border-gray-200 rounded-md overflow-hidden">
            ...
            <div className="p-4">
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/reception" className="text-blue-600 hover:underline">
                    4 Reception
                  </Link>
                </li>
                <li>
                  <Link href="/awards" className="text-blue-600 hover:underline">
                    5 Awards
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/external-links" className="text-blue-600 hover:underline">
                    7 External links
                  </Link>
                </li>
              </ul>
